...
namespace Testing.basic_tests
{
    public class DistributedBasicGroup : ITestDistributed
    {
        public void Do(DistributedDb db)
        {
            ...
            if (res.Count() != 3 || res.Where(f => f.Key == 5).First().Count != 1 || res.Where(f => f.Key == 3).First().Count != 1 || res.Where(f => f.Key == 10).First().Count != 2 ||
            ...
            if (res.Count() != 4 || res.Where(f => f.Key == 5).First().Count != 1 || res.Where(f => f.Key == 3).First().Count != 1 || res.Where(f => f.Key == 10).First().Count != 2 ||
                res.Where(f => f.Key == 5).First().Sum != 1.2 || res.Where(f => f.Key == 3).First().Sum != 7 || res.Where(f => f.Key == 10).First().Sum != 6.8 ||
