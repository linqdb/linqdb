        ...
        public static void Do()
        {
            ...
            try
            {
                ...
                var tests = new List<ITestDistributed>()
                {
                    ...
                    new DistributedBasicGroup2(),
                    new DistributedBasicGroup3(),
                    new DistributedBasicGroup4(),
                    new DistributedBasicGroup5(),
                    new DistributedBasicGroup6(),
                    new DistributedBasicGroup7(),
                    new DistributedGenericType(),
                    new DistributedPartitionedSimpleSave(),
                    new DistributedPartitionedBatchSave(),
                    new DistributedPartitionedSimpleWhere(),
                    new DistributedPartitionedNoId(),
                    new DistributedPartitionedOrderBy(),
                    new DistributedPartitionedOrderByDescending(),
                    new DistributedPartitionedTake(),
                    new DistributedPartitionedBetween(),
                    new DistributedPartitionedUpdate(),
                    new DistributedVectorSearchStats()
                };
