        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                var tests = new List<ITest>()
                {
                    ...
                    new PartitionedSimpleSave(),
                    new PartitionedBatchSave(),
                    new PartitionedSimpleWhere(),
                    new PartitionedAnd(),
                    new PartitionedOr(),
                    new PartitionedNoId(),
                    new PartitionedOrderBy(),
                    new PartitionedSkipTake(),
                    new PartitionedUpdate(),
                    new PartitionedDelete(),
                    new PartitionedParallelSave(),
                    new PartitionedManyWhere(),
                    new PartitionedManyPartitions(),
                    new SimpleSaveSid(),
                    new BadWhere4(),
                    new DateGroupBy(),
                    new BadWhere5(),
                    new BetweenZeroes(),
                    new DecimalCheck(),
                    new BasicGroupDecimal(),
                    new DecimalCheck2(),
                    new LongCheck(),
                    new BasicGroupLong(),
                    new LongCheck2(),
                    new MaxLongDecimal(),
                    new UpdateNonNullabeIntNull(),
                    new IntersectNonNullableIntNull(),
                    new WhereExpression2(),
                    new SearchBF(),
                    new SearchBF2(),
                    new SearchBF3(),
                    new SearchBF4(),
                    ...
                    new VectorSearch(),
                    new VectorSearchBig(),
                    new VectorSearchBigSmallDim(),
                    new VectorSearchStats(),
                    new VectorUpdateNull()
                };
