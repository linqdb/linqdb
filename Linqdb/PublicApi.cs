...
namespace LinqDb
{
    ...
    public class Db
    {
        ...
        /// </summary>
        public ILinqDbParitionedQueryable<T> PartitionedTable<T>(string partition) where T : new()
        {
            var _inter = _db.Table<T>();
            _inter.Partition = partition;
            return  new ILinqDbParitionedQueryable<T>() { _queryable = new ILinqDbQueryable<T>() { _internal = _inter } } ;
        }
        /// <summary>
    ...
    public class ILinqDbParitionedQueryable<T> where T : new()
    {
    ...
    public class ILinqDbQueryable<T> where T : new()
    {
        ...
        public int Save(T item)
        {
            if (item != null)
            {
                var prop = item.GetType().GetProperty("Sid");
                if (prop != null)
                {
            ...
            return _internal._db.Save(item, _internal);
        }
        /// <summary>
        ///  Saves any amount of items non-atomically, i.e. if it fails in the middle some items will be saved and some won't be.
        /// </summary>
        public void SaveNonAtomically(List<T> items, int batchSize = 5000)
        {
            ...
            var first = items[0];
            var prop = first.GetType().GetProperty("Sid");
            if (prop != null)
            {
                throw new LinqDbException("Linqdb: type cannot have Sid property, it is reserved for distributed table.");
            }
            for (int i = 0; ; i++)
            {
                ...
                _internal._db.SaveBatch(res, _internal);
            }            
        }
        /// <summary>
        ///  Same as Save but more efficient.
        ...
        public void SaveBatch(List<T> items)
        {
            ...
            _internal._db.SaveBatch(items, _internal);
        }
        /// <summary>
        ///  Record count.
        /// </summary>
        ...
        public void Delete(int id)
        {
            _internal._db.Delete<T>(new HashSet<int>() { id }, _internal);
        }
        /// <summary>
        ///  Deletes items with given Ids.
        /// </summary>
        public void Delete(HashSet<int> ids)
        {
            ...
            _internal._db.Delete<T>(ids, _internal);
        }
        /// <summary>
        ///  Deletes any amount of items non-atomically, i.e. if it fails in the middle some items will be deleted and some won't be.
        /// </summary>
        public void DeleteNonAtomically(HashSet<int> ids, int batchSize = 5000)
        {
            ...
            for (int i = 0; ; i++)
            {
                ...
                _internal._db.Delete<T>(new HashSet<int>(res), _internal);
            }
        }
        /// <summary>
        ///  Updates item's field with supplied value. Item is identified by Id.
        ...
        public void Update<TKey>(Expression<Func<T, TKey>> keySelector, int id, TKey value)
        {
            _internal._db.Update(keySelector, new Dictionary<int, TKey>() { { id, value } }, _internal);
        }
        /// <summary>
        ///  Updates item's fields with supplied values. Item are identified by Id.
        /// </summary>
        public void Update<TKey>(Expression<Func<T, TKey>> keySelector, Dictionary<int, TKey> values)
        {
            ...
            _internal._db.Update(keySelector, values, _internal);
        }
        ...
        public void UpdateNonAtomically<TKey>(Expression<Func<T, TKey>> keySelector, Dictionary<int, TKey> values, int batchSize = 5000)
        {
            ...
            for (int i = 0; ; i++)
            {
                ...
                _internal._db.Update(keySelector, res, _internal);
            }
        }
        /// <summary>
        ///  Selects anonymous type using result entities. Select only what's needed as it is more efficient.
        ...
        public List<R> Select<R>(Expression<Func<T, R>> predicate, LinqdbSelectStatistics statistics)
        {
            ...
            statistics.Distances = internalStatistics.Distances;
            return res;
        }
        ...
        public List<R> SelectNonAtomically<R>(Expression<Func<T, R>> predicate, int batchSize = 3000)
        {
            ...
            for (int i = 0; ; i++)
            {
                var cids = ids.Skip(i * batchSize).Take(batchSize).Select(f => f).ToList();
                if (!cids.Any())
                {
                    return results;   
                }
        ...
        public List<T> SelectEntity(LinqdbSelectStatistics statistics)
        {
            ...
            statistics.Distances = stats.Distances;
            return res;
        }
        ...
        public ILinqDbQueryable<T> Between<TKey>(Expression<Func<T, TKey>> keySelector, TKey from, TKey to, BetweenBoundaries boundaries = BetweenBoundaries.BothInclusive)
        {
            ...
            {
                _internal._db.Between(_internal, keySelector, (Convert.ToDateTime(from) - new DateTime(0001, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc)).TotalMilliseconds, (Convert.ToDateTime(to) - new DateTime(0001, 1, 1, 0, 0, 0, DateTimeKind.Utc)).TotalMilliseconds, (BetweenBoundariesInternal)(int)boundaries);
                return this;
            }
            else
            {
        ...
        public ILinqDbQueryable<T> Intersect<TKey>(Expression<Func<T, TKey>> keySelector, List<TKey> set)
        {
            _internal._db.Intersect(_internal, keySelector, new HashSet<TKey>(set));
            return this;
        }
        /// <summary>
        ...
        {
            _internal._db.SearchBitfunnel(_internal, keySelector, search_query, stop_res_count);
            return this;
        }
        /// <summary>
        ///  Full text search on a column. 
        ...
        public ILinqDbQueryable<T> SearchNeighbours<TKey>(Expression<Func<T, TKey>> keySelector, float[] vector, int k)
        {
            _internal._db.SearchNeighbours(_internal, keySelector, vector, k);
            return this;
        }
        /// <summary>
        ///  Applies where condition to the result set. 
        ...
        public void CreatePropertyMemoryIndex<TKey>(Expression<Func<T, TKey>> valuePropertySelector)
        {
            ...
            _internal._db.CreateIndex<T, TKey>(valuePropertySelector, false, 0, 0);
        }
        ...
        public double CreatePropertyBitFunnelMemoryIndex<TKey>(Expression<Func<T, TKey>> valuePropertySelector, int bitfunnel_size, int batch_size = 1024)
        {
            ...
            return _internal._db.CreateIndex<T, TKey>(valuePropertySelector, true, bitfunnel_size, batch_size);
        }
        ...
        public void RemovePropertyMemoryIndex<TKey>(Expression<Func<T, TKey>> valuePropertySelector)
        {
            ...
            _internal._db.RemoveIndex<T, TKey>(valuePropertySelector, false);
        }
        ...
        public void RemoveBitFunnelMemoryIndex<TKey>(Expression<Func<T, TKey>> valuePropertySelector)
        {
            ...
            _internal._db.RemoveIndex<T, TKey>(valuePropertySelector, true);
        }
