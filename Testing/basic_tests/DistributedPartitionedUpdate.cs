...
{
    public class DistributedPartitionedUpdate : ITestDistributed
    {
        public void Do(DistributedDb db)
        {
            ...
            db.DistributedPartitionedTable<SomeDataDistributed>(partition).Update(f => f.PeriodId, dic);

            res = db.DistributedPartitionedTable<SomeDataDistributed>(partition)
                        .Between(f => f.Normalized, 0.1, 0.9)
                        .Select(f => new
                        {
                            f.PeriodId
